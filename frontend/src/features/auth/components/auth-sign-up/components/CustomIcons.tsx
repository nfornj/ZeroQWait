...
export function ZeroQwaitLogo({ className, ...props }: IconProps) {
  return (
    <svg
      width={100}
      height={21}
      ...
      className={cn("h-[21px] w-[100px] text-foreground", className)}
      {...props}
    >
      <text x="0" y="18" fill="currentColor" fontFamily="Arial, sans-serif" fontWeight="bold" fontSize="18">
        ZeroQwait
      </text>
    </svg>
  );
